"""
Detector stage: scans each simulated frame for the target and writes
what it found (including missed frames) to detections.csv.

This is a placeholder color-blob detector — it looks for the red dot
drawn by scene_simulator.py. It exists so the pipeline is fully wired
end-to-end; swap this out for a real/AI-based detector later without
touching tracker.cpp (it only cares about detections.csv's columns).
"""
